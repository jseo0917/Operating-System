...
/*
** Function slow_down_output
** 
** Function to help debugging.
** It allows for the output to slow down so we can see what the
** output in the screen is. 
*/

void slow_down_output() {
    // comment the macros if you want the output to show up faster
...
void pass_on_CPU() {
    ...
    SYSTEM_SCHEDULER->yield(); // Schedule the next thread
}
...
int main() {
    ...
    /* -- INITIALIZE MEMORY -- */
    /*    NOTE: We don't have paging enabled in this project. */
    /*          (Good news! You do not need your P3/P4)       */
