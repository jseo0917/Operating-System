...
int main() {
    ...
    **    GENERATE MEMORY REFERENCES TO THE VM POOLS */
    ...
    debug_out_E9_msg_value("Space_available: ", space_available); // 32kb
    debug_out_E9_msg_value("addr1          : ", addr1); // base + 32kb
    debug_out_E9_msg_value("base           : ", base); // base
    debug_out_E9_msg_value("addr1-base     : ", addr1-base); // 32 kb
	...
	debug_out_E9_msg_value("addr2          : ", addr2); 
